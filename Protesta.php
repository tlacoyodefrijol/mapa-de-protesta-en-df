...
array_push($noprotestan_academicos_hijos, $noprotestan_academicos_unam);
...
array_push($nombres_secgob, "Director General de concertación política y atención social y ciudadana");
...
$nombres_pc=array();
array_push($nombres_pc, "Subsecretario de Coordinación de Planes y Programas Preventivos");
...
array_push($nombres_segob_desc, "Secretario de Gobernación desc");
array_push($nombres_segob_desc, "Subdirector de Divulgación y Concertación desc");
array_push($nombres_segob_desc, "Subdirector De Atención a La Comisión De Política Gubernamental en Materia de Derechos Humanos desc");
